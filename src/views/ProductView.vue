  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-6">
        ...
        <div class="h5"
        v-if="productData.origin_price === productData.price">{{productData.origin_price}} 元</div>
        <div v-else>
...
export default {
  ...
  methods: {
    getProductData() {
      this.$http.get(`${process.env.VUE_APP_API}/v2/api/${process.env.VUE_APP_PATH}/product/${this.$route.params.id}`)
        .then((res) => {
